...
import com.google.android.accessibility.privacypolicy.XpqPrivacyDialog.Companion.xpqprivacypolicy

class XPQPrivacyPolicyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_xpqprivacy_policy)
    ...
    private fun initView() {
        ...
        web_view?.loadUrl(xpqprivacypolicy)
    }
